...
func (m *CarMutation) SetRegisterAt(t time.Time) {
	m.register_at = &t
}

// RegisterAt returns the value of the "register_at" field in the mutation.
func (m *CarMutation) RegisterAt() (r time.Time, exists bool) {
	v := m.register_at
	if v == nil {
		return
	}
...
// OldRegisterAt returns the old "register_at" field's value of the Car entity.
// If the Car object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CarMutation) OldRegisterAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CarMutation) ResetRegisterAt() {
	m.register_at = nil
}
...
func (m *CarMutation) Fields() []string {
	...
	if m.register_at != nil {
		fields = append(fields, car.FieldRegisterAt)
	}
	return fields
}
