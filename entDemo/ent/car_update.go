...
func (cu *CarUpdate) SetRegisterAt(t time.Time) *CarUpdate {
	cu.mutation.SetRegisterAt(t)
	return cu
}

// SetNillableRegisterAt sets the "register_at" field if the given value is not nil.
func (cu *CarUpdate) SetNillableRegisterAt(t *time.Time) *CarUpdate {
	if t != nil {
		cu.SetRegisterAt(*t)
	}
	return cu
...
func (cu *CarUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.RegisterAt(); ok {
...
// SetRegisterAt sets the "register_at" field.
func (cuo *CarUpdateOne) SetRegisterAt(t time.Time) *CarUpdateOne {
	cuo.mutation.SetRegisterAt(t)
	return cuo
}

// SetNillableRegisterAt sets the "register_at" field if the given value is not nil.
func (cuo *CarUpdateOne) SetNillableRegisterAt(t *time.Time) *CarUpdateOne {
	if t != nil {
		cuo.SetRegisterAt(*t)
	}
	return cuo
...
func (cuo *CarUpdateOne) sqlSave(ctx context.Context) (_node *Car, err error) {
	...
	if value, ok := cuo.mutation.RegisterAt(); ok {
		_spec.SetField(car.FieldRegisterAt, field.TypeTime, value)
	}
